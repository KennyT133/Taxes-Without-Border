...
function finalPriceAlc() {
  const stateArray = ["AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY"];
  const alcTax = [.04, 0, .056, .065, .0725, .029, .0635, 0, .06, .06, .04, .06, .0625, .07, .06, .065, .06, .0445, .055, .06, .0625, .06, .0685, 0, .0665, .0513, .04, .0476, .05, .0575, .045, 0, .06, .07, .0625, .0595, .06, .053, .065, .06, .05, .04];
  var state = document.getElementById("statename").value;
  var price = document.getElementById("priceval").value;
  var pos = true;
  var x = parseFloat(price);
...
function finalPriceTob(){
  const stateArray = ["AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY"];
  const tobTax = [.04, 0, .056, .065, .0725, .029, .0635, 0, .06, .06, .04, .06, .0625, .07, .06, .065, .06, .0445, .05, .06, .0625, .06, .0688, .07, .0423, 0, .055, .0685, 0, .0665, .0513, .04, .0475, .05, .0575, .045, 0, .06, .07, .06, .045, .07, .0625, .0595, .06, .053, .065, .06, .05, .04];
  var state = document.getElementById("statename").value;
  var price = document.getElementById("priceval").value;
  var pos = true;
  var x = parseFloat(price);
